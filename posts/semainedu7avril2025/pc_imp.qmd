...
### **Practice Exercise**  
1. Yesterday, I ___ (watch) TV when you ___ (call).  
   → *Je **regardais** la télé quand tu **as appelé**.*  
2. She ___ (be) always smiling when she ___ (work).  
...
1. Hier, je ___ (regarder) la télé quand tu ___ (appeler).  
   → *Je **regardais** la télé quand tu **as appelé**.*  
2. Elle ___ (être) toujours souriante quand elle ___ (travailler).  
   → *Elle **était** toujours souriante quand elle **travaillait**.*  
