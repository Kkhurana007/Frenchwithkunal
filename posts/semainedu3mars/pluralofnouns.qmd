...
<script>
const usersDatabase = ["Khuranasoilpau@gmail.com", "user2@example.com"]; // Add your authorized users here
const userInput = prompt("Enter your email to view this post:");

if (!usersDatabase.includes(userInput)) {
  const language = document.documentElement.lang; // Detect the language of the page
  if (language === "fr") {
    alert("Vous n'avez pas accès à cet article. Veuillez vous abonner pour y accéder.");
  } else {
    alert("You do not have access to this post. Please subscribe to gain access.");
  }
  window.location.href = "https://frenchwithkunal.ca/payment.html"; // Redirect to the subscription/payment page
}
</script>
