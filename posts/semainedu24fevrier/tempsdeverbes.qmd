...
French verb tenses can seem daunting at first, but once you understand their structure and usage, they become a powerful tool for expressing yourself clearly. [In today’s lecture](https://drive.google.com/file/d/1d6abMu8t_2GCdx7MO77UrMFxtPRV6q3-/view?usp=drive_link), we explored the most commonly used French verb tenses - **nine** out of the fifteen. Let’s break them down one by one with examples to help you master them.  
...
Les temps verbaux en français peuvent sembler complexes au premier abord, mais une fois que vous en comprenez la structure et l’utilisation, ils deviennent un outil puissant pour vous exprimer clairement. [Dans le cours d’aujourd’hui](https://drive.google.com/file/d/1d6abMu8t_2GCdx7MO77UrMFxtPRV6q3-/view?usp=drive_link), nous avons exploré les temps verbaux les plus couramment utilisés en français—neuf sur les quinze existants. Décomposons-les un par un avec des exemples pour vous aider à les maîtriser.  
