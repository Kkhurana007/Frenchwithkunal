...
je vends (je vends)
tu vends (tu vends, informel)
il/elle vend (il/elle vend)
nous vendons (nous vendons)
vous vendez (vous vendez, formel/pluriel)
ils/elles vendent (ils/elles vendent)
La plupart des verbes en -re, comme attendre (attendre) ou perdre (perdre), suivent ce modèle de conjugaison régulier, ce qui les rend prévisibles et relativement faciles à conjuguer dans différents temps. Cependant, comme pour d'autres catégories de verbes, certains verbes en -re sont irréguliers et ne suivent pas ces règles.
