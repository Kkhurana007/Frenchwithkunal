...
Je prefere le thé. → <textarea rows="1" cols="30" placeholder="Phrase corrigée..."></textarea>  
<button onclick="checkCorrectionFr(this.previousElementSibling, 'Je préfère le thé.')">Vérifier</button>  
<span class="feedback"></span>

Nous esprons partir. → <textarea rows="1" cols="30" placeholder="Phrase corrigée..."></textarea>  
<button onclick="checkCorrectionFr(this.previousElementSibling, 'Nous espérons partir.')">Vérifier</button>  
<span class="feedback"></span>  
...
She hopes to travel. → <textarea rows="1" cols="40" placeholder="Traduction française..."></textarea>  
<button onclick="checkTranslationFr(this.previousElementSibling, 'Elle espère voyager.')">Vérifier</button>  
<span class="feedback"></span>  

We buy a car. → <textarea rows="1" cols="40" placeholder="Traduction française..."></textarea>  
<button onclick="checkTranslationFr(this.previousElementSibling, 'Nous achetons une voiture.')">Vérifier</button>  
<span class="feedback"></span>  
...
<textarea rows="5" cols="100" placeholder="Ex : J’achète des légumes..."></textarea>  
<button onclick="highlightStemChangeVerbsFr(this.previousElementSibling)">Mettre en évidence</button>  
<div class="feedback"></div>  
