...
- **Masculine countries (usually end with a consonant, e.g., le Canada, le Japon):**  
    Use **au**  
    _Ex: Je vais **au** Canada. / J'habite **au** Japon._

- **Feminine countries (usually end with -e, e.g., la France, l’Italie):**  
    Use **en**  
    _Ex: Je vais **en** France. / J'habite **en** Italie._

- **Plural countries (e.g., les États-Unis, les Pays-Bas):**  
    Use **aux**  
    _Ex: Je vais **aux** États-Unis. / J'habite **aux** Pays-Bas._

### b) Regions, Provinces, Continents

- **Feminine regions/continents:**  
    Use **en**  
    _Ex: Je vais **en** Bretagne. / Je suis **en** Afrique._

- **Masculine regions:**  
    Use **dans le**  
    _Ex: Je vais **dans le** Limousin._

### c) Cities and Villages

- Use **à**  
    _Ex: Je vais **à** Paris. / J'habite **à** Québec._

### d) Other Places

- Use **à** for most places (school, work, etc.):  
    _Ex: Je vais **à** l’école. / Je travaille **à** l’hôpital._
...
- **Masculine countries:**  
    Use **du**  
    _Ex: Je viens **du** Canada._

- **Feminine countries:**  
    Use **de**  
    _Ex: Je viens **de** France._

- **Countries starting with a vowel or mute h:**  
    Use **d’**  
    _Ex: Je viens **d’Italie**._

- **Plural countries:**  
    Use **des**  
    _Ex: Je viens **des** États-Unis._

### b) Regions, Provinces, Continents

- **Feminine:**  
    Use **de**  
    _Ex: Je viens **de** Bretagne._

- **Masculine:**  
    Use **du**  
    _Ex: Je viens **du** Limousin._

### c) Cities and Villages

- Use **de** (or **d’** before a vowel)  
    _Ex: Je viens **de** Paris. / Je viens **d’Avignon**._

### d) Other Places

- Use **de** (or **de l’**, **du**, **des** as needed):  
    _Ex: Je viens **de l’école**. / Je viens **du travail**._
...
_Ex: C’est la ville **où** je suis né. (This is the city where I was born.)_
...
1. Je vais ________ Espagne. <input type="text" placeholder="" oninput="checkAnswer(this, 'en')"> <span></span>
2. Nous habitons ________ États-Unis. <input type="text" placeholder="" oninput="checkAnswer(this, 'aux')"> <span></span>
3. Il vient ________ Japon. <input type="text" placeholder="" oninput="checkAnswer(this, 'du')"> <span></span>
4. Elle va ________ Paris. <input type="text" placeholder="" oninput="checkAnswer(this, 'à')"> <span></span>
5. Tu viens ________ Italie ? <input type="text" placeholder="" oninput="checkAnswer(this, 'd’')"> <span></span>
6. Nous allons ________ Bretagne cet été. <input type="text" placeholder="" oninput="checkAnswer(this, 'en')"> <span></span>
7. Je viens ________ Limousin. <input type="text" placeholder="" oninput="checkAnswer(this, 'du')"> <span></span>
8. Ils habitent ________ Pays-Bas. <input type="text" placeholder="" oninput="checkAnswer(this, 'aux')"> <span></span>
9. Elle vient ________ école. <input type="text" placeholder="" oninput="checkAnswer(this, 'de l’')"> <span></span>
10. Nous allons ________ village voisin. <input type="text" placeholder="" oninput="checkAnswer(this, 'au')"> <span></span>
11. Je viens ________ Canada. <input type="text" placeholder="" oninput="checkAnswer(this, 'du')"> <span></span>
12. Il va ________ Afrique. <input type="text" placeholder="" oninput="checkAnswer(this, 'en')"> <span></span>
13. Tu viens ________ Marseille ? <input type="text" placeholder="" oninput="checkAnswer(this, 'de')"> <span></span>
14. Nous habitons ________ Québec. <input type="text" placeholder="" oninput="checkAnswer(this, 'à')"> <span></span>
15. Elle va ________ hôpital. <input type="text" placeholder="" oninput="checkAnswer(this, 'à l’')"> <span></span>
...
_Ex : C’est la ville **où** je suis né(e)._
