...
> **Note:**  
> - Use **où** to ask about location: _Où est la bibliothèque ?_ (Where is the library?)
> - Prepositions are followed by **de** (of), which may contract: _à côté du parc_ (next to the park), _en face de l’école_ (opposite the school).
...
1. Le chat est ________ la chaise. <input type="text" placeholder="" oninput="checkAnswer(this, 'sous')"> <span></span>
2. La voiture est ________ la maison. <input type="text" placeholder="" oninput="checkAnswer(this, 'devant')"> <span></span>
3. Le café est ________ la banque. <input type="text" placeholder="" oninput="checkAnswer(this, 'à côté de')"> <span></span>
4. Le parc est ________ la rue. <input type="text" placeholder="" oninput="checkAnswer(this, 'de l\'autre côté de')"> <span></span>
5. Le livre est ________ la table. <input type="text" placeholder="" oninput="checkAnswer(this, 'sur')"> <span></span>
6. La fontaine est ________ la place. <input type="text" placeholder="" oninput="checkAnswer(this, 'au milieu de')"> <span></span>
7. L’école est ________ la poste. <input type="text" placeholder="" oninput="checkAnswer(this, 'en face de')"> <span></span>
8. Les clés sont ________ le sac. <input type="text" placeholder="" oninput="checkAnswer(this, 'dans')"> <span></span>
9. Le jardin est ________ la maison. <input type="text" placeholder="" oninput="checkAnswer(this, 'derrière')"> <span></span>
10. Le cinéma est ________ la bibliothèque. <input type="text" placeholder="" oninput="checkAnswer(this, 'à côté de')"> <span></span>
11. Le banc est ________ l’arbre. <input type="text" placeholder="" oninput="checkAnswer(this, 'sous')"> <span></span>
12. Le supermarché est ________ la pharmacie. <input type="text" placeholder="" oninput="checkAnswer(this, 'en face de')"> <span></span>

---

## 2. Asking for Directions: Complete the questions

1. ________ , où est la gare ? (polite) <input type="text" placeholder="" oninput="checkAnswer(this, 'Excusez-moi')"> <span></span>
2. ________ me dire où se trouve la pharmacie ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Pouvez-vous')"> <span></span>
3. ________ aller à la bibliothèque ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Comment')"> <span></span>
4. ________ est le musée, s’il vous plaît ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Où')"> <span></span>
5. ________ est la boulangerie ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Où')"> <span></span>
6. ________ puis-je trouver un arrêt de bus ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Où')"> <span></span>
7. ________ pour aller au parc ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Comment')"> <span></span>
8. ________ indiquer la route pour l’hôpital ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Pouvez-vous')"> <span></span>
9. ________ , où se trouve la mairie ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Excusez-moi')"> <span></span>
10. ________ est la station de métro la plus proche ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Où')"> <span></span>
11. ________ aller à la plage ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Comment')"> <span></span>

---

## 3. Giving Directions: Choose the correct option

1. Pour aller à la poste, ________ tout droit.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'allez')"> <span></span>
2. ________ à gauche au feu.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'Tournez')"> <span></span>
3. ________ la rue et c’est en face.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'Traversez')"> <span></span>
4. La boulangerie est ________ la pharmacie.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'à côté de')"> <span></span>
5. ________ à droite après le pont.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'Tournez')"> <span></span>
6. ________ jusqu’au bout de la rue.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'Allez')"> <span></span>
7. ________ le parc et continuez tout droit.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'Traversez')"> <span></span>
8. ________ la première rue à gauche.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'Prenez')"> <span></span>
9. ________ devant la mairie, puis tournez à droite.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'Passez')"> <span></span>
10. ________ à la deuxième intersection.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'Tournez')"> <span></span>
11. ________ la place et c’est à gauche.  
    <input type="text" placeholder="" oninput="checkAnswer(this, 'Traversez')"> <span></span>
...
> **Remarque :**  
> - Utilisez **où** pour demander un lieu : _Où est la bibliothèque ?_
> - Les prépositions sont suivies de **de** (du, de la, de l’, des) selon le mot qui suit.
...
1. ________ , où est la gare ? (poli) <input type="text" placeholder="" oninput="checkAnswer(this, 'Excusez-moi')"> <span></span>
2. ________ me dire où se trouve la pharmacie ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Pouvez-vous')"> <span></span>
3. ________ aller à la bibliothèque ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Comment')"> <span></span>
4. ________ est le musée, s’il vous plaît ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Où')"> <span></span>
5. ________ est la boulangerie ? <input type="text" placeholder="" oninput="checkAnswer(this, 'Où')"> <span></span>
