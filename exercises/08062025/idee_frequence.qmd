...
1. Je prends mon petit-déjeuner ________. <input type="text" placeholder="" oninput="checkAnswer(this, 'le matin')"> <span></span>
2. Nous allons à la gym ________. <input type="text" placeholder="" oninput="checkAnswer(this, 'deux fois par semaine')"> <span></span>
3. Il boit du café ________. <input type="text" placeholder="" oninput="checkAnswer(this, 'à chaque repas')"> <span></span>
4. Elle lit un livre ________. <input type="text" placeholder="" oninput="checkAnswer(this, 'le soir')"> <span></span>
5. Tu fais du sport ________? (every day) <input type="text" placeholder="" oninput="checkAnswer(this, 'tous les jours')"> <span></span>
6. Nous sortons ________ au restaurant. <input type="text" placeholder="" oninput="checkAnswer(this, 'souvent')"> <span></span>
7. Je regarde ________ la télévision. (rarely) <input type="text" placeholder="" oninput="checkAnswer(this, 'rarement')"> <span></span>
8. Il est ________ en avance. (always) <input type="text" placeholder="" oninput="checkAnswer(this, 'toujours')"> <span></span>
9. Elle ne mange ________ de viande. (never) <input type="text" placeholder="" oninput="checkAnswer(this, 'jamais')"> <span></span>
10. Nous voyageons ________. (from time to time) <input type="text" placeholder="" oninput="checkAnswer(this, 'de temps en temps')"> <span></span>
11. Je prends un café ________. (at noon) <input type="text" placeholder="" oninput="checkAnswer(this, 'à midi')"> <span></span>
12. Ils vont au cinéma ________. (sometimes) <input type="text" placeholder="" oninput="checkAnswer(this, 'parfois')"> <span></span>
...
1. Je fais du yoga chaque matin. (tous les jours)  
    → <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Je fais du yoga tous les jours.')"> <span></span>
2. Nous allons au marché le samedi. (une fois par semaine)  
    → <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Nous allons au marché une fois par semaine.')"> <span></span>
3. Il prend un dessert à chaque repas. (toujours)  
    → <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Il prend toujours un dessert.')"> <span></span>
4. Elle ne boit pas de café. (jamais)  
    → <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Elle ne boit jamais de café.')"> <span></span>
5. Nous faisons du vélo parfois. (de temps en temps)  
    → <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Nous faisons du vélo de temps en temps.')"> <span></span>
...
1. I eat breakfast every morning.  
    <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Je prends le petit-déjeuner tous les matins.')"> <span></span>
2. She goes to the gym twice a week.  
    <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Elle va à la gym deux fois par semaine.')"> <span></span>
3. We always arrive on time.  
    <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Nous arrivons toujours à l’heure.')"> <span></span>
4. He never eats meat.  
    <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Il ne mange jamais de viande.')"> <span></span>
5. They rarely watch TV.  
    <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Ils regardent rarement la télévision.')"> <span></span>
6. I drink coffee at noon.  
    <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Je bois du café à midi.')"> <span></span>
7. We go to the cinema from time to time.  
    <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Nous allons au cinéma de temps en temps.')"> <span></span>
8. She sometimes eats at the restaurant.  
    <input type="text" style="width: 350px;" placeholder="" oninput="checkAnswer(this, 'Elle mange parfois au restaurant.')"> <span></span>
...
3. Il boit du café ________. <input type="text" placeholder="" oninput="checkAnswer(this, 'à chaque repas')"> <span></span>
4. Elle lit un livre ________. <input type="text" placeholder="" oninput="checkAnswer(this, 'le soir')"> <span></span>
5. Tu fais du sport ________ ? <input type="text" placeholder="" oninput="checkAnswer(this, 'tous les jours')"> <span></span>
6. Nous sortons ________ au restaurant. <input type="text" placeholder="" oninput="checkAnswer(this, 'souvent')"> <span></span>
7. Je regarde ________ la télévision. <input type="text" placeholder="" oninput="checkAnswer(this, 'rarement')"> <span></span>
8. Il est ________ en avance. <input type="text" placeholder="" oninput="checkAnswer(this, 'toujours')"> <span></span>
9. Elle ne mange ________ de viande. <input type="text" placeholder="" oninput="checkAnswer(this, 'jamais')"> <span></span>
10. Nous voyageons ________. <input type="text" placeholder="" oninput="checkAnswer(this, 'de temps en temps')"> <span></span>
11. Je prends un café ________. <input type="text" placeholder="" oninput="checkAnswer(this, 'à midi')"> <span></span>
12. Ils vont au cinéma ________. <input type="text" placeholder="" oninput="checkAnswer(this, 'parfois')"> <span></span>
